...
open class SlideMenuController: UIViewController, UIGestureRecognizerDelegate {
    ...
    open func changeMainViewController(_ mainViewController: UIViewController,  close: Bool, position: Int) {
        removeViewController(self.mainViewController)
        self.mainViewController = mainViewController
        setUpViewController(mainContainerView, targetViewController: mainViewController)
    //    self.delegate?.itemClicked!(index: position)
        if close {
            closeLeft()
            closeRight()
        }
    ...
    open func forceChangeMainViewController(_ mainViewController: UIViewController) {
        removeViewController(self.mainViewController)
        self.mainViewController = mainViewController
        setUpViewController(mainContainerView, targetViewController: mainViewController)
     }
    
    //    open func positionClicked(index:Int) {
    //        self.delegate?.itemClicked!(index: index)
    //    }
    //
